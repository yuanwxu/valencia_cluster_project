...
get_sts2Treedater <- function(epi_info, tre){
  ...
  if(anyNA(sts2)) warning("Missing sampling times in cluster epi data.")
...
We apply the new routine `infer_multiTTree_shareParam` to the list of timed trees corresponding to clusters `r names_cl`, 
...
We compute the index case distribution for each individual cluster.
